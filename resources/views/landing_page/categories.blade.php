<!-- resources/views/landing_page/categories.blade.php -->
<section id="categories" class="section-padding bg-white">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid-4-cols sm-grid-2-cols lg-grid-4-cols">
            <!-- Category 1 -->
            <a href="{{ route('products.index', ['category' => 'nail-polish']) }}" class="category-card">
            ...
            <!-- Category 2 -->
            <a href="{{ route('products.index', ['category' => 'nail-tools']) }}" class="category-card">
                <div class="relative h-full">
            ...
            <!-- Category 3 -->
            <a href="{{ route('products.index', ['category' => 'nail-care']) }}" class="category-card">
                <div class="relative h-full">
            ...
            <!-- Category 4 -->
            <a href="{{ route('products.index', ['category' => 'nail-kit']) }}" class="category-card">
                <div class="relative h-full">
