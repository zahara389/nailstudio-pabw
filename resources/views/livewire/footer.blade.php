  ...
  <div id="footer-wrapper">
    <div class="newsletter-container">
      ...
      <form class="newsletter-form">
        <input class="email-input" placeholder="Enter your email" required="" type="email"/>
    ...
    <footer class="footer-main">
      ...
      <div class="bottom-bar">
        ...
        <div class="payment-logos">
          ...
          <img alt="Zip logo black" class="payment-logo" height="20" src="https://upload.wikimedia.org/wikipedia/commons/3/3a/Zip_logo_black.svg" width="40"/>
